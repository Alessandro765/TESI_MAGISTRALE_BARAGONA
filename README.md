...
## Istruzioni certificazione codice
...
## Popolare le variabili nell'env:

**Chiave per le API di OpenAI**: OPENAI_API_KEY = "codice chiave opean ai"
...
* **Area Principale (Chat)**: un box informativo guida l'utente.
...
* **Sidebar Sinistra (Report di Analisi)** un cruscotto dinamico che si popola solo dopo l'analisi:
